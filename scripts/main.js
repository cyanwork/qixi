...
function loadImages(sources, callback){
    ...
    loader.addProgressListener(function(e) {
        ...
        $(".loading-progress .bar .fill").css({
            width: percent
        });
        //$(".loading-progress .num").html(percent);
...
loadImages([
    /**IMAGES**//*pre*/"./images/bg.png"/*pre*/,
/*pre*/"./images/p1.png"/*pre*/,
/*pre*/"./images/p2.png"/*pre*/,
/*pre*/"./images/p3.png"/*pre*/,
/*pre*/"./images/p4.png"/*pre*/,
/*pre*/"./images/p5.png"/*pre*/,
/*pre*/"./images/p6.png"/*pre*/,
/*pre*/"./images/p7.png"/*pre*/,
/*pre*/"./images/story1.png"/*pre*/,
/*pre*/"./images/story2.png"/*pre*/,
/*pre*/"./images/story3.png"/*pre*/,
/*pre*/"./images/story4.png"/*pre*/,
/*pre*/"./images/story5.png"/*pre*/,
/*pre*/"./images/story6.png"/*pre*/,
/*pre*/"./images/story7.png"/*pre*/,
/*pre*/"./images/temp1.png"/*pre*/,
/*pre*/"./images/temp2.png"/*pre*/,
/*pre*/"./images/temp3.png"/*pre*/,
/*pre*/"./images/temp4.png"/*pre*/,
/*pre*/"./images/temp5.png"/*pre*/,
/*pre*/"./images/temp6.png"/*pre*/,
/*pre*/"./images/temp7.png"/*pre*/,
/*pre*/"./images/title.png"/*pre*/,
/*pre*/"./images/w1.png"/*pre*/,
/*pre*/"./images/w2.png"/*pre*/,
/*pre*/"./images/w3.png"/*pre*/,
/*pre*/"./images/w4.png"/*pre*/,
/*pre*/"./images/w5.png"/*pre*/,
/*pre*/"./images/w6.png"/*pre*/,
/*pre*/"./images/w7.png"/*pre*//**IMAGES**/
], function () {

    var photos = $('.photos');

    var photoItems = photos.find('img');
    var title = $('.title img');
    var weatherItems = $('.weather img');
    var tempItems = $('.temperature img');
    var storyItems = $('.story img');
    ...
    photoPos.forEach(function(prop, i){
        TweenMax.set(photoItems.eq(i), prop);
    });

    //温度
    TweenMax.set(tempItems, {
        opacity:0
    });
    TweenMax.set(tempItems.eq(0), {
        opacity:1
    });
    //天气
    TweenMax.set(weatherItems, {
        opacity:0
    });
    TweenMax.set(weatherItems.eq(0), {
        opacity:1
    });
    //故事
    TweenMax.set(storyItems, {
        opacity:0
    });
    TweenMax.set(storyItems.eq(0), {
        opacity:1
    });
    ...
    tl.add([
        TweenMax.staggerFrom($([tempItems.eq(0), weatherItems.eq(0), title, storyItems.eq(0)]), 0.4, {
            opacity:0,
            scale: 0.8
        }, 0.2),
        TweenMax.staggerFrom(photoItems, 0.4, {
            scale:1.3,
            rotation: 0,
            y:-180,
            opacity:0,
    ...
    function changeStage(type){
        ...
        TweenMax.to(weatherItems.eq(currentIndex), 0.4, {
            opacity:0
        });

        TweenMax.to(storyItems.eq(currentIndex), 0.4, {
            opacity:0
        });

        TweenMax.to(tempItems.eq(currentIndex), 0.4, {
            opacity:0,
            y:40,
            delay:0.3
        });
        ...
        TweenMax.fromTo(weatherItems.eq(currentIndex), 0.4, {
            y:-30,
            opacity:0
        },{
            opacity:1,
        ...
        TweenMax.fromTo(storyItems.eq(currentIndex), 0.6, {
            x:30,
            opacity:0
        },{
            opacity:1,
        ...
        TweenMax.fromTo(tempItems.eq(currentIndex), 0.6, {
            y:30,
            opacity:0
        },{
            opacity:1,
        ...
        var topPhoto = photoItems.eq(photoItems.length - currentIndex);
        var animProp = base[type];
        animProp.opacity = 0;

        TweenMax.to(topPhoto, 0.4, animProp);


        for(var i=0; i<photoItems.length - currentIndex; i++){
            TweenMax.to(photoItems.eq(i), 0.4, photoPos[i+currentIndex]);
        }
    ...
    var hammerphotos = new Hammer($('body')[0], {});
    hammerphotos.get('swipe').set({ direction: Hammer.DIRECTION_ALL });
    hammerphotos.on('swipeleft swiperight swipeup swipedown', function(ev) {
        changeStage(ev.type);
    });
    ...
    function computeSize(){
        var scaleNum = 1050/591;
        var winWidth = $(window).width();
        var winHeight = $(window).height();
        if(winHeight/winWidth < scaleNum){
            $('.inside-wrapper').width(winHeight/scaleNum);
        }else{
            $('.inside-wrapper').css('width', '100%');
        }
    }
    computeSize();
    ...
    $(".bgm-controller").on('click touchend', function(e){
        e.preventDefault();
